...
export { default as EnumArrayControlRenderer } from './EnumArrayControlRenderer.vue';
...
import { entry as EnumArrayControlRendererEntry } from './EnumArrayControlRenderer.vue';
