<template>
  <q-page padding>
    ...
    <ul>
      <li>Maybe you want to setup the camera? <a href="https://photobooth-app.org/setup/camera_setup/">Move on
          to camera
          setup documentation</a></li>
      <li>Need some extras? Watch out for WLED integration, sync files and more <a
          href="https://photobooth-app.org/extras/">extras</a>.</li>
      <li>Got in trouble? Find help in the <a href="https://photobooth-app.org/support/troubleshooting/">troubleshooting
          guide</a>.</li>
      <li>Still problems? <a href="https://github.com/photobooth-app/photobooth-app/discussions">Reach out in a
          discussion</a>.</li>
    </ul>
